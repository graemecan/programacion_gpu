...
__global__ void update_wave(double cfl, double* un, double* un_m1, double* un_p1){
...
int main(){
    ...
    for (int t = 0; t < Nt; t++){
        ...
        update_wave<<<blocks, threads>>>(cfl, un, un_m1, un_p1);
